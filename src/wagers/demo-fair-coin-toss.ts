...
export function demoFairCoinToss_ChoiceFromJSON(
  object: any
...
export function demoFairCoinToss_ChoiceToJSON(
  object: DemoFairCoinToss_Choice
): string {
  switch (object) {
...
export const DemoFairCoinToss = {
  ...
  create<I extends Exact<DeepPartial<DemoFairCoinToss>, I>>(
    base?: I
  ): DemoFairCoinToss {
    return DemoFairCoinToss.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<DemoFairCoinToss>, I>>(
    object: I
  ): DemoFairCoinToss {
    const message = createBaseDemoFairCoinToss();
