...
export declare const MessageContext: {
    ...
    } & { [K_18 in Exclude<keyof I, keyof MessageContext>]: never; }>(base?: I | undefined): MessageContext;
    fromPartial<I_1 extends {
        ...
        fairCoinToss?: ({
            ...
            playerChoice?: import("./message-contexts/fair-coin-toss").FairCoinToss_Choice | undefined;
        } & { [K_19 in Exclude<keyof I_1["fairCoinToss"], "playerChoice">]: never; }) | undefined;
        vhempCrash?: ({} & {} & { [K_20 in Exclude<keyof I_1["vhempCrash"], never>]: never; }) | undefined;
        hilo?: ({
            start?: {
                amount?: {
                    currency?: import("./currency").Currency | undefined;
            ...
            start?: ({
                ...
                amount?: ({
                    ...
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
                } & { [K_21 in Exclude<keyof I_1["hilo"]["start"]["amount"], keyof import("./amount").Amount>]: never; }) | undefined;
                startingCard?: import("./message-contexts/hilo").Card | undefined;
            } & { [K_22 in Exclude<keyof I_1["hilo"]["start"], keyof import("./message-contexts/hilo").HiLoStart>]: never; }) | undefined;
            move?: ({
                playerChoice?: import("./message-contexts/hilo").HiLoMove_Choice | undefined;
                moveIndex?: number | undefined;
            } & {
                playerChoice?: import("./message-contexts/hilo").HiLoMove_Choice | undefined;
                moveIndex?: number | undefined;
            } & { [K_23 in Exclude<keyof I_1["hilo"]["move"], keyof import("./message-contexts/hilo").HiLoMove>]: never; }) | undefined;
        } & { [K_24 in Exclude<keyof I_1["hilo"], keyof HiLo>]: never; }) | undefined;
        crashDice?: ({
            amount?: {
                currency?: import("./currency").Currency | undefined;
                value?: number | undefined;
            ...
            amount?: ({
                ...
                currency?: import("./currency").Currency | undefined;
                value?: number | undefined;
            } & { [K_25 in Exclude<keyof I_1["crashDice"]["amount"], keyof import("./amount").Amount>]: never; }) | undefined;
            target?: number | undefined;
            houseEdge?: number | undefined;
        } & { [K_26 in Exclude<keyof I_1["crashDice"], keyof CrashDice>]: never; }) | undefined;
        bobRoulette?: ({
            blackBets?: {
                uname?: string | undefined;
                amount?: {
            ...
            blackBets?: ({
                ...
                amount?: ({
                    ...
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
                } & { [K_27 in Exclude<keyof I_1["bobRoulette"]["blackBets"][number]["amount"], keyof import("./amount").Amount>]: never; }) | undefined;
            } & { [K_28 in Exclude<keyof I_1["bobRoulette"]["blackBets"][number], keyof import("./message-contexts/bob-roulette").BOBRoulette_Bet>]: never; })[] & { [K_29 in Exclude<keyof I_1["bobRoulette"]["blackBets"], keyof {
                uname?: string | undefined;
                amount?: {
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
            ...
            orangeBets?: ({
                ...
                amount?: ({
                    ...
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
                } & { [K_30 in Exclude<keyof I_1["bobRoulette"]["orangeBets"][number]["amount"], keyof import("./amount").Amount>]: never; }) | undefined;
            } & { [K_31 in Exclude<keyof I_1["bobRoulette"]["orangeBets"][number], keyof import("./message-contexts/bob-roulette").BOBRoulette_Bet>]: never; })[] & { [K_32 in Exclude<keyof I_1["bobRoulette"]["orangeBets"], keyof {
                uname?: string | undefined;
                amount?: {
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
            ...
            bonusBets?: ({
                ...
                amount?: ({
                    ...
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
                } & { [K_33 in Exclude<keyof I_1["bobRoulette"]["bonusBets"][number]["amount"], keyof import("./amount").Amount>]: never; }) | undefined;
            } & { [K_34 in Exclude<keyof I_1["bobRoulette"]["bonusBets"][number], keyof import("./message-contexts/bob-roulette").BOBRoulette_Bet>]: never; })[] & { [K_35 in Exclude<keyof I_1["bobRoulette"]["bonusBets"], keyof {
                uname?: string | undefined;
                amount?: {
                    currency?: import("./currency").Currency | undefined;
                    value?: number | undefined;
        ...
        } & { [K_36 in Exclude<keyof I_1["bobRoulette"], keyof BOBRoulette>]: never; }) | undefined;
    } & { [K_37 in Exclude<keyof I_1, keyof MessageContext>]: never; }>(object: I_1): MessageContext;
};
