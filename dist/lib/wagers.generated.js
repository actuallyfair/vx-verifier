...
const demo_fair_coin_toss_generated_1 = require("./wager_kinds/demo_fair_coin_toss.generated");
...
exports.Wager = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.demoFairCoinToss !== undefined) {
            demo_fair_coin_toss_generated_1.DemoFairCoinToss.encode(message.demoFairCoinToss, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    message.demoFairCoinToss = demo_fair_coin_toss_generated_1.DemoFairCoinToss.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            demoFairCoinToss: isSet(object.demoFairCoinToss) ? demo_fair_coin_toss_generated_1.DemoFairCoinToss.fromJSON(object.demoFairCoinToss) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        message.demoFairCoinToss !== undefined &&
            (obj.demoFairCoinToss = message.demoFairCoinToss ? demo_fair_coin_toss_generated_1.DemoFairCoinToss.toJSON(message.demoFairCoinToss) : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.demoFairCoinToss = (object.demoFairCoinToss !== undefined && object.demoFairCoinToss !== null)
            ? demo_fair_coin_toss_generated_1.DemoFairCoinToss.fromPartial(object.demoFairCoinToss)
            : undefined;
        return message;
    },
};
